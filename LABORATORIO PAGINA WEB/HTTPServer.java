jaime@Jaime:~/sistemasOperativosII/operativos/sockets$ cat HTTPServer.java
import java.io.*;
import java.net.*;
import java.util.*;
...
public class HTTPServer extends Thread {
        ...
        public static void main(String args[]) throws Exception {
                ...
                ServerSocket Server = new ServerSocket(8080, 10, InetAddress.getByName("172.20.31.171"));
